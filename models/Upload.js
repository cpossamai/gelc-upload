    ...
    try {
      if (!this.errors.length) {
        ...
        uploadsCollection.insertOne(this.data).then(() => {
          ...
          console.log("error in Upload.create err:1 ", e)
          this.errors.push("Please try again later err:1. " + e)
          reject(this.errors)
        })
      } else {
        console.log("error in Upload.create err:2 ", e)
        this.errors.push("Please try again later err:2.")
        reject(this.errors)
      }
